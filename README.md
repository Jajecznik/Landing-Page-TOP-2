...
This project is about creating an entire web page from a provided design that comes in the form of 2 images. One is an image of the complete website, and one has some details about some of the fonts and colors we’ve used.
